...
#define BT_UUID_LBS_ADVERTISING_VAL      BT_UUID_128_ENCODE(0x000062C4, 0xB99E, 0x4141, 0x9439, 0xC4F9DB977899)
...
#define BT_UUID_LBS_ADVERTISING    BT_UUID_DECLARE_128(BT_UUID_LBS_ADVERTISING_VAL)
